const questions = [
    {
        question:" True or False:The Silent Patient is a psychological thriller novel.",
        answers:[
...

    {
        ...
        answers:[
            {text:"Sarah Smith",correct:false},
            {text:" David Johnson",correct:false},
            {text:"Lisa Anderson",correct:false}, 
            {text:"Alicia Berenson",correct:true},
        ]

    },

    {
        question:" True or False: Endless Night is a mystery novel by Agatha Christie.",
        answers:[
            {text:"True",correct:true},
            {text:"False",correct:false},
