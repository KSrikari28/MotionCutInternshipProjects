const questions = [
    {
        question:" Sapiens is a non-fiction book. (True/False)",
        answers:[
...

    {
        ...
        answers:[
            {text:"Otto Frank",correct:false},
            {text:"Agatha Christie",correct:false},
            {text:"Anne Frank",correct:true}, 
            {text:"Antony Beevor",correct:false},
        ]

    },

    {
        question:" What is the theme of Into Thin Air",
        answers:[
            {text:" The Natural World",correct:true},
    ...
    {
        question:" Who is the author of the book Sapiens: A Brief History of Humankind?",
        answers:[
            {text:" Yuval Noah Harari",correct:true},
